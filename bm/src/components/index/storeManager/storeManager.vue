<template>
  <div class="public">
    <div class="public-search">
      <span class="ml-3 w-35 text-gray-600 inline-flex items-center">名称</span>
      <el-input
          v-model="input1"
          class="w-50 m-2"
          placeholder="请输入用户名称"
      ...
      />
      <span class="ml-3 w-35 text-gray-600 inline-flex items-center" style="margin-left: 20px">类型</span>
    ...
    <div class="public-body">
      ...
      <div class="public-body-content">
        ...
        >
          ...
          <el-table-column prop="date" label="名称" width="100" />
          ...
          <el-table-column prop="name" label="电话" width="100" />
          <el-table-column prop="name" label="包仓面积(㎡)" width="150" />
          <el-table-column prop="name" label="包仓拖数" width="100" />
          <el-table-column >
